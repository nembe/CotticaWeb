...
public class AccountClientTest {
	...
	public void getAccount() {
		...
		final Account account = restTemplate.getForObject(url, Account.class, 0);
	...
	public void createAccount() {
		...
		final Account account = new Account(BigDecimal.valueOf(1000.50), BigDecimal.valueOf(20.00), "Eddie");
		monitor = MonitorFactory.start("JavaMonitor");
		final URI newAccountLocation = restTemplate.postForLocation(url, account);
		monitor.stop();
	...
	public void listAccounts() {
		...
		final ResponseEntity<Account[]> responseEntity = restTemplate.getForEntity(url, Account[].class);
